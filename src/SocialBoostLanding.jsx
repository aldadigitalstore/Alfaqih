...
const SocialBoostLanding = () => {
  ...
  const baseWhatsappLink = "https://wa.me/6282225134818";
  const whatsappLink = `${baseWhatsappLink}?text=Halo%20kak,%20saya%20tertarik%20dengan%20layanan%20Alfaqih...`;
      ...
      <nav className="fixed w-full z-50 bg-slate-950/80 backdrop-blur-md border-b border-white/10">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent cursor-pointer">
            Alfaqih<span className="text-white">.</span>
          </div>
      ...
      <section id="why-us" className="py-20 bg-slate-900">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
             ...
             <p className="text-slate-400">Keunggulan layanan Alfaqih dibandingkan yang lain</p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-slate-400">
                <li>WhatsApp: +62 822-2513-4818</li>
                <li>Email: support@Alfaqih.com</li>
          ...
          <div className="border-t border-white/5 pt-8 text-center text-slate-500">
            <p>&copy; {new Date().getFullYear()} Alfaqih Indonesia. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
